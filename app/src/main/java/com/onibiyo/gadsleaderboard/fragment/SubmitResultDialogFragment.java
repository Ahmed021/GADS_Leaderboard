...
public class SubmitResultDialogFragment extends DialogFragment {
    ...
    public static SubmitResultDialogFragment newInstance() {
        SubmitResultDialogFragment dialogFragment = new SubmitResultDialogFragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (success) {
            ...
            view.setCompoundDrawablesWithIntrinsicBounds(0, R.drawable.ic_check_success, 0, 0);
        } else {
